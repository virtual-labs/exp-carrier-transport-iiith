...
$$
<<<<<<< HEAD
\vec{J_{n}} = -(q_{n} \cdot v_{d,n}) = -q_{n}(-\mu _{n} \cdot v_{d,n}) = q_{n}\mu _{n} v_{d,n} \tag{4.3}
$$
For holes: 
$$
\vec{J_{p}} = (q_{p} \cdot v_{d,p}) = q_{p}(\mu _{p} \cdot v_{d,p}) = q_{p}\mu _{p} v_{d,p} \tag{4.4}
=======
...
$$
<<<<<<< HEAD
\vec{J_{drift}} = \sigma \cdot \vec{E} = \frac{\vec{E}}{\rho} \tag{4.6}
=======
...
$$
<<<<<<< HEAD
F_{n} = -D_{n} \cdot \frac{dn}{dx} \tag{4.7}
=======
...
$$
<<<<<<< HEAD
F_{p} = D_{p} \cdot \frac{dp}{dx} \tag{4.8}
=======
...
$$
<<<<<<< HEAD
J_{n} = -e D_{n}\frac{dn}{dx} \tag{4.10}
=======
...
$$
<<<<<<< HEAD
J_{diff} = e(D_{n}\frac{dn}{dx}-D_{p}\frac{dp}{dx}) \tag{4.11}
$$
The total current density in semiconductor is the sum of drift current and diffusion current and is given by
$$
J = J_{drift}+J_{diff} \tag{4.12}
$$ 
$$
J = e(p\mu_{o} +n\mu_{o}) +e(D_{n}\frac{dn}{dx}-D_{p}\frac{dp}{dx})\tag{4.13}
=======
